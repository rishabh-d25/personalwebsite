                ...
                <div className="bg-image position-relative"
                    ...
                    <article className="accordion h-75 w-75">
                        ...
                        <section className="h-100" id ="acc1" onClick={() => {
                            ...
                            <p>Over the years, I've taken a variety of classes at Conant. Some of the most unique and memorable ones
                            included field trips downtown, starting my own business, and much more. I've also been fortunate enough to
                            have some great teachers over the years who truly made everyone look forward to coming to class.</p>
                            <Slider {...settings2}>
                                <div className="card" style={{width: "18rem"}}>
